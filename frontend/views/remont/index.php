...
<section class="content">
	...
	<noindex><a href="<?= yii\helpers\Url::home();?>">Главная</a></noindex>
        ...
        <div class="fastOrder">
			...
			<button type="submit" name="sendRemontOrder" value="1" class="btn success">Записаться на Ремонт</button>
                        </div>
                  <?php ActiveForm::end(); ?>
        </div>
    </div>
...
<script>
    ...
    googleCaptcha.registerForm('button[name="sendRemontOrder"]', 'recaptchaResponse4');
</script>
<script> // @change on new recaptcha
...
<div class="carWorks table bordered">
	<div class="topic">
		<h2><label for="open_group_12">Цены на работы по ремонту <?=$value['car']['title']; ?></label></h2>
